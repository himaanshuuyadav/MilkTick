...
class LocalRepository(
    ...
    suspend fun getPendingPaymentEntities(): List<MonthlyPaymentEntity> = database.monthlyPaymentDao().getPendingSyncPayments()
    ...
    suspend fun markPaymentSynced(userId: String, yearMonth: String) {
        database.monthlyPaymentDao().markAsSynced(userId, yearMonth)
    }

    suspend fun markPaymentFailed(userId: String, yearMonth: String) {
        database.monthlyPaymentDao().markAsFailed(userId, yearMonth)
    }
